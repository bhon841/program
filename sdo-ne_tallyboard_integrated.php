 		...
 		<div class="col-sm-12 col-lg-6">
				...
				?>
		 		...
		 		<table style="border:solid 2px; width: 500px; font-size:14px;">
		 			<tr align="center" style="background: silver">
		 				<th></th>
		 				<th width="200px">GRADE 11 Councilor</th>
		 				
		 				<th>TOTAL VOTE</th>
		 			</tr>
				<?php
				$get_participant = "SELECT * FROM participants, partylist WHERE participants.pid = partylist.pid AND participants.participant_position = 'Grade 11 Representative'";
				$result2 = $con->query($get_participant);
				while($row = $result2->fetch_assoc()){
					$name     = $row['participant_name'];
				...
				$get_participant2 = "SELECT * FROM participants WHERE participant_position = 'Grade 11 Representative' AND pid = '0'";
				$result3 = $con->query($get_participant2);
				while($row = $result3->fetch_assoc()){
					$name     = $row['participant_name'];
				...
				?>
		 		...
		 		<table style="border:solid 2px; width: 500px; font-size:14px;">
		 			<tr align="center" style="background: silver">
		 				<th></th>
		 				<th width="200px">GRADE 12 Councilor</th>
		 				
		 				<th>TOTAL VOTE</th>
		 			</tr>
				<?php
				$get_participant = "SELECT * FROM participants, partylist WHERE participants.pid = partylist.pid AND participants.participant_position = 'Grade 12 Representative'";
				$result2 = $con->query($get_participant);
				while($row = $result2->fetch_assoc()){
					$name     = $row['participant_name'];
				...
				$get_participant2 = "SELECT * FROM participants WHERE participant_position = 'Grade 12 Representative' AND pid = '0'";
				$result3 = $con->query($get_participant2);
				while($row = $result3->fetch_assoc()){
					$name     = $row['participant_name'];
