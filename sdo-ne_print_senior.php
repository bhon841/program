...
/*		$pdf->SetX('29');
		...
		$max_g11 = mysqli_query($con,"SELECT MAX(total_votes) FROM participants WHERE participant_position = 'Grade 11 Representative'");
		$row_max_g11 = mysqli_fetch_array($max_g11);
		$max_votes_g11 = $row_max_g11['MAX(total_votes)'];
...
/*		$pdf->SetX('29');
		...
		$max_g12 = mysqli_query($con,"SELECT MAX(total_votes) FROM participants WHERE participant_position = 'Grade 12 Representative'");
		$row_max_g12 = mysqli_fetch_array($max_g12);
		$max_votes_g12 = $row_max_g12['MAX(total_votes)'];
