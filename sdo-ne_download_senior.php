...
*/
		...
		$row_result = mysqli_fetch_array($result);
			$comelec = $row_result['comelec_name'];
				...
				$pdf->Cell(30,10,"",1,0,'');				
				$pdf->Ln(10);
		$pdf->Output("results_final/standaloneResult-(SY$sy_qr)-$id_qr-$current_month$current_day$time.pdf", 'F');
		$pdf->Output("standaloneResult-(SY$sy_qr)-$id_qr-$current_month$current_day$time.pdf", 'D');
		ob_end_flush();
		header("location:tally_board_elementary.php");
	?>
</body>
</html>